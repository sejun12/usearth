...
public class AdminVisitController {
    ...
    public String allVisit(@RequestParam(value = "check", required = false) Boolean check,SearchVisitDTO searchVisitDTO, Pagination pagination, Model model, HttpSession session){
        //동 호수 없으시
        if (check != null) {
